...
public class ServiceOrderListActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.lbl_yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                serviceOrder.setActive(!serviceOrder.isActive());
                                serviceOrder.save();
                                String status = "Arquivada";
                                if(serviceOrder.isActive()){
                                    status = "Ativada";
                                }
                                Toast.makeText(ServiceOrderListActivity.this, "Ordem de serviço " + status +" com sucesso!", Toast.LENGTH_LONG).show();
                                // Update recycler view dataset
                                if (serviceOrder.isActive() == true){
                                    updateRecyclerItens(ServiceOrder.getAll("1"));
                                }else{
                                    updateRecyclerItens(ServiceOrder.getAll("0"));
                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case  R.id.actionAtivos:
                updateRecyclerItens(ServiceOrder.getAll("0"));
                return true;

            case R.id.actionTodos:
                updateRecyclerItens(ServiceOrder.getAllWithoutFilter());
                return true;
        }
