...
public class ServiceOrder implements Parcelable {
    ...
    public static List<ServiceOrder> getAll(String active) {
        return ServiceOrdersRepository.getInstance().getAll(active);
    }

    public static List<ServiceOrder> getAllWithoutFilter() {
        return ServiceOrdersRepository.getInstance().getAllWithoutFilter();
    }
